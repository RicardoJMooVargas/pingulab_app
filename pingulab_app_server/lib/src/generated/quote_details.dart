...
abstract class QuoteDetails
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      if (filamentDetails != null)
        'filamentDetails':
            filamentDetails?.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      if (supplyDetails != null)
        'supplyDetails':
            supplyDetails?.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      if (customer != null) 'customer': customer?.toJsonForProtocol(),
      if (printer != null) 'printer': printer?.toJsonForProtocol(),
      if (shipping != null) 'shipping': shipping?.toJsonForProtocol(),
    };
  }
